...
/**
 * @Description executorService.invokeAll
 * 线程池中所有线程结束就结束等待
 * @Author
 * @Date 2020/2/27 23:13
 **/
@Slf4j
public class Demo02ExecutorServiceInvokeAll {
    ...
    static void test() {
        ...
        try {
            ...
            List<Future<String>> result = executorService.invokeAll(callables, 10, TimeUnit.SECONDS);
